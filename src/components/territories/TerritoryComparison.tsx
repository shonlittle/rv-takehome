    ...
    <div>
      <div className="mb-4 sm:mb-6">
        ...
        <select
          ...
          className="mt-1 block w-full pl-2 sm:pl-3 pr-8 sm:pr-10 py-1.5 sm:py-2 text-xs sm:text-sm border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
        >
        ...
        {sortedTerritories.length > 0 ? (
          sortedTerritories.map(([territory, stats]) => {
            ...
            return (
              <div
                key={territory}
                className="bg-white rounded-md p-3 sm:p-4 shadow-sm"
              >
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 sm:h-4 overflow-hidden">
                  <div
                    className={`${barColor} h-3 sm:h-4 rounded-full`}
          ...
          <div className="text-center text-xs sm:text-sm text-gray-500 py-3 sm:py-4">
